...
#define OCTAVE_CONF_BLAS_LIBS "-lcblas -lf77blas -latlas"
#endif
...
#define OCTAVE_CONF_CC_VERSION "4.6.3 (MacPorts gcc46 4.6.3_9) "
#endif
...
#define OCTAVE_CONF_CFLAGS "-g -O2 -D_THREAD_SAFE -pthread"
#endif
...
#define OCTAVE_CONF_CXX_VERSION "4.6.3"
#endif
...
#define OCTAVE_CONF_DL_LDFLAGS "-bundle -bundle_loader ../src/octave -L/mnt/oqtansTools/oqtans_dep/lib/ -L/opt/local/lib"
#endif
...
#define OCTAVE_CONF_FLIBS "-L/mnt/oqtansTools/oqtans_dep/lib/ -L/opt/local/lib -L/opt/local/lib/gcc45/gcc/x86_64-apple-darwin11/4.5.4 -L/opt/local/lib/gcc45/gcc/x86_64-apple-darwin11/4.5.4/../../.. -lm -lgfortran"
#endif
...
#define OCTAVE_CONF_FT2_LIBS "-L/opt/local/lib -lfreetype -lz -lbz2"
#endif
...
#define OCTAVE_CONF_GRAPHICS_LIBS "-L/opt/local/lib -lfltk_gl -framework AGL -framework OpenGL -framework ApplicationServices -lfltk -lpthread -framework Cocoa"
#endif
...
#define OCTAVE_CONF_LDFLAGS "-L/mnt/oqtansTools/oqtans_dep/lib/ -L/opt/local/lib"
#endif
...
#define OCTAVE_CONF_LIBS "-lm  -L/mnt/oqtansTools/oqtans_dep/lib/ -L/opt/local/lib"
#endif
...
#define OCTAVE_CONF_MAGICK_CPPFLAGS "-I/opt/local/include/GraphicsMagick  "
#endif

#ifndef OCTAVE_CONF_MAGICK_LDFLAGS
#define OCTAVE_CONF_MAGICK_LDFLAGS "-L/opt/local/lib  "
#endif
...
#define OCTAVE_CONF_MKOCTFILE_DL_LDFLAGS "-bundle -bundle_loader $BINDIR/octave-$OCTAVE_VERSION$EXEEXT"
#endif
...
#define OCTAVE_CONF_OPENGL_LIBS "-L/opt/local/lib -lfontconfig   -Wl,-framework -Wl,OpenGL"
#endif
...
#define OCTAVE_CONF_PTHREAD_CFLAGS "-D_THREAD_SAFE -pthread"
#endif
...
#define OCTAVE_CONF_REGEX_LIBS "-L/opt/local/lib -lpcre"
#endif
...
#define OCTAVE_CONF_SED "/opt/local/bin/gsed"
#endif
...
#define OCTAVE_CONF_SHLEXT "dylib"
#endif

#ifndef OCTAVE_CONF_SHLEXT_VER
#define OCTAVE_CONF_SHLEXT_VER "3.4.3.dylib"
#endif
...
#define OCTAVE_CONF_SH_LDFLAGS "-dynamiclib -single_module -L/mnt/oqtansTools/oqtans_dep/lib/ -L/opt/local/lib"
#endif

#ifndef OCTAVE_CONF_SONAME_FLAGS
#define OCTAVE_CONF_SONAME_FLAGS "-install_name /mnt/oqtansTools/oqtans_dep/octave-3.4.3/lib/octave/3.4.3/oct-conf.h"
#endif
...
#define OCTAVE_CONF_X11_INCFLAGS "/opt/local/include"
#endif

#ifndef OCTAVE_CONF_X11_LIBS
#define OCTAVE_CONF_X11_LIBS "-L/opt/local/lib -lX11"
#endif
...
#define OCTAVE_CONF_XTRA_CXXFLAGS "-I/opt/local/include -I/opt/local/include/freetype2 -I/opt/local/include -I/opt/local/include  "
#endif
...
#define OCTAVE_CONF_config_opts "'LD_LIBRARY_PATH=/mnt/oqtansTools/oqtans_dep/lib' 'CPPFLAGS=-I/mnt/oqtansTools/oqtans_dep/include' 'LIBS=-L/mnt/oqtansTools/oqtans_dep/lib/ -L/opt/local/lib' 'LDFLAGS=-L/mnt/oqtansTools/oqtans_dep/lib/ -L/opt/local/lib' 'F77=gfortran' '--prefix=/mnt/oqtansTools/oqtans_dep/octave-3.4.3' '--with-glpk-includedir=/mnt/oqtansTools/oqtans_dep/include' '--with-glpk-libdir=/mnt/oqtansTools/oqtans_dep/lib' '--with-qhull-includedir=/mnt/oqtansTools/oqtans_dep/include/' '--with-qhull-libdir=/mnt/oqtansTools/oqtans_dep/lib' '--with-qrupdate-libdir=/mnt/oqtansTools/oqtans_dep/lib/' '--with-qrupdate-includedir=/mnt/oqtansTools/oqtans_dep/include/' '--without-framework-carbon' '--enable-64' '--without-umfpack'"
#endif
