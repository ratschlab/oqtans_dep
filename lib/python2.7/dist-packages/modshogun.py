...
RANDOM_MAX = _modshogun.RANDOM_MAX
...
class LongIntVector(_object):
    ...
    def get_element(self, *args):
        """get_element(self, index) -> long long const &"""
...
class ULongIntVector(_object):
    ...
    def get_element(self, *args):
        """get_element(self, index) -> unsigned long long const &"""
...
class StreamingStringLongFeatures(StreamingFeatures):
    ...
    def get_vector(self):
        """get_vector(self) -> shogun::SGString< long long >"""
...
class StreamingStringUlongFeatures(StreamingFeatures):
    ...
    def get_vector(self):
        """get_vector(self) -> shogun::SGString< unsigned long long >"""
...
class StreamingSparseLongFeatures(StreamingDotFeatures):
    ...
    __del__ = lambda self : None;
    def get_feature(self, *args):
        """get_feature(self, index) -> long long"""
...
class StreamingSparseUlongFeatures(StreamingDotFeatures):
    ...
    __del__ = lambda self : None;
    def get_feature(self, *args):
        """get_feature(self, index) -> unsigned long long"""
