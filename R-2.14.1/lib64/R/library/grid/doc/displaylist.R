...
###################################################
### code chunk number 1: displaylist.Rnw:23-29
###################################################
library(grDevices)
...
###################################################
### code chunk number 5: displaylist.Rnw:99-100 (eval = FALSE)
###################################################
## grid.edit("gr", gp = gpar(col = "red", lwd = 3))


###################################################
### code chunk number 6: displaylist.Rnw:130-131
###################################################
grid.rect(width = convertWidth(unit(1, "inches"), "npc"))


###################################################
### code chunk number 7: displaylist.Rnw:139-144
###################################################
...
###################################################
### code chunk number 8: displaylist.Rnw:158-174
###################################################
...
###################################################
### code chunk number 9: displaylist.Rnw:181-199
###################################################
...
###################################################
### code chunk number 10: displaylist.Rnw:208-213
###################################################
...
###################################################
### code chunk number 11: displaylist.Rnw:229-238
###################################################
