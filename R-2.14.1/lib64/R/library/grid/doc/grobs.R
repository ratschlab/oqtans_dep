...
###################################################
### code chunk number 1: grobs.Rnw:23-27
###################################################
library(grDevices)
library(grid)
...
###################################################
### code chunk number 2: grobs.Rnw:41-43
###################################################
gl <- linesGrob()
...
###################################################
### code chunk number 3: grobs.Rnw:57-61
###################################################
grid.newpage()
...
###################################################
### code chunk number 4: grobs.Rnw:77-84
###################################################
grid.newpage()
...
###################################################
### code chunk number 5: grobs.Rnw:96-106
###################################################
grid.newpage()
pushViewport(viewport(w = .5, h = .5))
myplot <-
...
###################################################
### code chunk number 6: grobs.Rnw:114-117
###################################################
grid.newpage()
...
###################################################
### code chunk number 7: grobs.Rnw:126-130
###################################################
grid.newpage()
...
###################################################
### code chunk number 8: grobs.Rnw:155-169
###################################################
grid.newpage()
...
###################################################
### code chunk number 9: grobs.Rnw:187-199
###################################################
grid.newpage()
...
###################################################
### code chunk number 10: grobs.Rnw:207-212
###################################################
grid.newpage()
...
###################################################
### code chunk number 11: grobs.Rnw:217-233
###################################################
grid.newpage()
...
###################################################
### code chunk number 12: grobs.Rnw:245-254
###################################################
grid.newpage()
fg <- frameGrob()
fg <- packGrob(fg, textGrob("Hi there"))
...
###################################################
### code chunk number 13: grobs.Rnw:278-302
###################################################
grid.newpage()
pushViewport(viewport(layout = grid.layout(2, 2)))
drawIt <- function(row, col) {
...
###################################################
### code chunk number 14: grobs.Rnw:309-330
###################################################
gplot <- gTree(x = NULL, y = NULL,
               childrenvp = vpTree(
                 plotViewport(c(5, 4, 4, 2), name = "plotRegion"),
...
###################################################
### code chunk number 15: grobs.Rnw:341-352
###################################################
...
###################################################
### code chunk number 16: grobs.Rnw:358-371
###################################################
myplot <- gTree(name = "myplot",
                children = gList(
                  rectGrob(name = "box", gp = gpar(col = "grey")),
...
###################################################
### code chunk number 17: grobs.Rnw:392-408
###################################################
myplot <- gTree(name = "myplot",
                children = gList(rectGrob(name = "box", gp = gpar(col = "grey")),
                  xaxisGrob(name = "xaxis")))
...
###################################################
### code chunk number 18: grobs.Rnw:426-457
###################################################
drawIt <- function(row, col) {
  pushViewport(viewport(layout.pos.col = col, layout.pos.row = row))
  grid.rect(gp = gpar(col = "grey"))
...
###################################################
### code chunk number 19: grobs.Rnw:465-475
###################################################
grid.newpage()
